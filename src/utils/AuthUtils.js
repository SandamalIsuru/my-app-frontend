...
export const getPasswordConstraintSchema = (oldPasswordField = 'null') => {
  return {
    password: Yup.string()
      ...
      .matches(PASSWORD_POLICY.SPECIAL_CHARACTERS_REGEX, PASSWORD_POLICY.SPECIAL_CHARACTERS_ERROR)
      .notOneOf([Yup.ref(oldPasswordField), null], 'New password cannot be the same as the old password'),
